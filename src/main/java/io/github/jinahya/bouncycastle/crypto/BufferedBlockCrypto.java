...
public class BufferedBlockCrypto
        extends AbstractCrypto<BufferedBlockCipher> {

    public BufferedBlockCrypto(final BufferedBlockCipher cipher, final CipherParameters params) {
        super(cipher, params);
    }
...
//        return BufferedBlockCipherUtils.processBytesAndDoFinal(cipher, in, inoff, inlen, out, outoff);
//    }
    ...
    public byte[] encrypt(final byte[] in, final int inoff, final int inlen) throws InvalidCipherTextException {
        ...
        final var outlen = BufferedBlockCipherUtils.processBytesAndDoFinal(cipher, in, inoff, inlen, out, 0);
...
//        cipher.init(true, params);
//        return BufferedBlockCipherUtils.processAllBytesAndDoFinal(cipher, in, out, inbuf, outbuf);
